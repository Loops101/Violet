// ==================== Configuration ====================
// All configuration now handled via details.js
...
const curryVideo = document.getElementById("curry-video"); // Curry video
...
yesBtn.addEventListener("click", () => {
    ...
    // 3. Play Video logic
    // Play Curry Video
    if (curryVideo && SITE_DETAILS.curryVideo) {
        curryVideo.src = SITE_DETAILS.curryVideo;
        curryVideo.style.display = "block";
        curryVideo.muted = false;
        curryVideo
            .play()
            .then(() => {
                console.log("Curry video playing successfully");
            })
            .catch((e) => {
                console.error("Curry video autoplay blocked, trying muted:", e);
                curryVideo.muted = true;
                curryVideo.play();
            });
    }

    // Play YouTube Video (if youtubeVideoId is set in details.js)
    if (youtubeVideo && SITE_DETAILS.youtubeVideoId) {
        youtubeVideo.src = `https://www.youtube.com/embed/${SITE_DETAILS.youtubeVideoId}?autoplay=1`;
...
if (downloadBtn) {
    downloadBtn.addEventListener("click", () => {
        ...
        link.href = SITE_DETAILS.puzzleImage || "images/Her.jpg";
...
if (whatsappBtn) {
    whatsappBtn.addEventListener("click", () => {
        const number = SITE_DETAILS.whatsappNumber || "";
        const text = "It's a YES! ❤️";
